...
subprojects {
    ...
    aliucord {
        author("Der_Googler", 543912065182466059L)
        updateUrl.set("https://raw.githubusercontent.com/DerGoogler/aliucord-plugins/builds/updater.json")
        buildUrl.set("https://raw.githubusercontent.com/DerGoogler/aliucord-plugins/builds/%s.zip")
    }
